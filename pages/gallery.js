    ...
    return (
      <div>
        <Head>
          ...
          <meta
            name="description"
            content="Explore the Vintage Medical Centre gallery. View our modern facilities, state-of-the-art equipment, and welcoming environment designed to provide premium healthcare services."
          />
        </Head>
        <TopHeader />
        <Navbar />
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            >
              {galleryImages.map((image, index) => (
                <div
                  key={index}
                  className="relative group cursor-pointer h-[30vh]"
                >
                  <Image
                    src={image.src}
                    alt={image.alt}
