...
export default function Appointment() {
    ...
    return (
      <div>
        <Head>
          <title>Book an Appointment | Vintage Medical Centre</title>
          <meta
            name="description"
            content="Take control of your health today. Book an appointment with Vintage Medical Centre for prompt, professional, and personalized medical care tailored to your needs."
          />
        </Head>
        <TopHeader />
        <Navbar />
          ...
          <div className="mx-auto max-w-7xl">
            <div className="flex flex-col lg:flex-row justify-between items-start gap-0 lg:gap-8 py-16 px-6 sm:px-16">
              <div className="w-full lg:w-2/3 text-center lg:text-left text-white">
                <h2
                  className="text-2xl lg:text-3xl font-extrabold text-gray-900 mb-4"
                  data-aos="fade-up"
                ...
                <p
                  className="mt-6 text-sm lg:text-base leading-6 text-gray-800"
                  data-aos="fade-up"
                  data-aos-duration="500"
                  data-aos-delay="200"
                >
                  Take control of your health journey. Book an appointment with
                  Vintage Medical Centre today and experience prompt,
                  professional, and personalized care tailored to your specific
                  needs. Your well-being is our priority. Kindly, fill the form
                  to get started.
                </p>
              </div>

              <div
                className="mt-12 lg:mt-0 w-full lg:w-1/3 bg-white p-8 rounded-3xl shadow-xl ring-1 ring-gray-900/10"
                data-aos="fade-up"
                data-aos-duration="500"
                data-aos-delay="400"
              >
                <form
                  action="https://formsubmit.co/vintagemedical@gmail.com"
                  method="POST"
