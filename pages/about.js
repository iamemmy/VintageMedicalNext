        ...
        <div>
            ...
            <div className="bg-transparent">
                ...
                <div className="max-w-7xl mx-auto py-16 px-6 lg:px-8 text-center">
                    <h1 className="text-2xl lg:text-3xl font-extrabold text-gray-900">About Us</h1>
                    <p className="mt-6 text-sm lg:text-base leading-6 text-gray-800 max-w-5xl mx-auto">
                    ...
                    <div className="bg-transparent py-6">
                        <div className="max-w-7xl mx-auto px-6 lg:px-8">
                            <div className="lg:text-center">
                                ...
                                <p className="mt-4 text-sm lg:text-base leading-6 text-gray-600 max-w-3xl mx-auto">
                ...
                <div className="relative overflow-hidden py-16 sm:py-24 bg-transparent">
                    ...
                    <div className="bg- text-blackwhite py-6">
                        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
                            <h2 className="text-2xl lg:text-3xl font-bold">Meet Our MD</h2>
                            <p className="mt-4 text-sm lg:text-base max-w-3xl mx-auto">
