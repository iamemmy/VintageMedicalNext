...
const ContactUs = () => {
    ...
    return (
      <div>
        <Head>
          <title>Contact Us | Vintage Medical Centre</title>
          <meta
            name="description"
            content="Get in touch with Vintage Medical Centre today. Reach out to our team for inquiries, appointments, or healthcare support. We are here to provide the assistance you need."
          />
        </Head>
        <TopHeader />
        <Navbar />
        <div className="relative bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            >
              ...
              contact form or visit us at our location.
            </p>
