      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="container mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="flex flex-col items-center sm:items-start">
            ...
            />
            <p className="text-sm lg:text-base leading-6 text-start">
              Your trusted partner in healthcare, offering personalized care and
              a range of medical services to meet your needs.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm lg:text-base">
              ...
              <li>
                <Link href="/appointment" className="hover:text-indigo-400">
                  Book Appointment
                </Link>
              </li>
              {isHomePage && (
                <li>
                  <Link href="#faqs-section" className="hover:text-indigo-400">
                    FAQs
                  </Link>
                </li>
              )}
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm lg:text-base">
              ...
              <li>Phone: +234(0)9067770993 | +234(0)8098587274</li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm lg:text-base">
              ...
              <li>
                <Link href="/hmo" className="hover:text-indigo-400">
                  HMO Accreditation
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-gray-700 pt-6 text-center text-sm">
          <p className="mb-2 text-sm lg:text-base">
            &copy; 2025 Vintage Medical Centre. All rights reserved.
          </p>
          <p>
            Designed by{" "}
            <Link
